/**
 * Fetches current weather data based on latitude and longitude using OpenWeatherMap API.
 *
 * @param {number} lat - Latitude of the location.
 * @param {number} lon - Longitude of the location.
 * @returns {Promise<Object>} Formatted weather data including weather condition, temperature, and activity message.
 *
