...
const { validateMedicationData, validateMedicationId, validateMedicationUpdate, validateMarkAsTaken, validateReminderRequest, validateAnalyticsRequest } = require("./middlewares/medicationValidation.js");
const { validateCaregiverRelationship, validatePatientId, validateMissedMedicationAlert, validateDashboardRequest, validateAdherenceReportRequest } = require("./middlewares/caregiverValidation.js");
const { validateEmergencyContactData, validateContactId, validateEmergencyContactUpdate, validateEmergencyAlert, validateAlertHistoryRequest } = require("./middlewares/emergencyContactValidation.js");
const { validateHealthMetric, validateHealthMetricsQuery, validateAdherenceReportParams, validateHealthAnalyticsParams, validateHealthDashboardParams } = require("./middlewares/healthMetricsValidation.js");
 ...
 */
app.post("/api/medications", authenticateJWT, validateMedicationData, medicationController.createMedication);
 ...
 */
app.put("/api/medications/:medicationId", authenticateJWT, validateMedicationId, validateMedicationUpdate, medicationController.updateMedication);
 ...
 *       - bearerAuth: []
 */
app.delete("/api/medications/:medicationId", authenticateJWT, validateMedicationId, medicationController.deleteMedication);
 ...
 *       - bearerAuth: []
 */
app.post("/api/medications/:medicationId/mark-taken", authenticateJWT, validateMedicationId, validateMarkAsTaken, medicationController.markMedicationTaken);
 ...
 *       - bearerAuth: []
 */
app.get("/api/medications/reminders/upcoming", authenticateJWT, validateReminderRequest, medicationController.getUpcomingReminders);
 ...
 *       - bearerAuth: []
 */
app.get("/api/medications/analytics", authenticateJWT, validateAnalyticsRequest, medicationController.getAdherenceAnalytics);
 ...
 *       - bearerAuth: []
 */
app.get("/api/medications/missed", authenticateJWT, medicationController.getMissedMedications);
 ...
 *       - bearerAuth: []
 */
app.put("/api/appointments/:appointmentId", authenticateJWT, appointmentController.updateAppointment);
 ...
 *       - bearerAuth: []
 */
app.delete("/api/appointments/:appointmentId", authenticateJWT, appointmentController.deleteAppointment);
 ...
 *       - bearerAuth: []
 */
app.get("/api/caregiver/patients", authenticateJWT, caregiverController.getCaregiverPatients);
 ...
 *       - bearerAuth: []
 */
app.get("/api/caregiver/patients/:patientId/dashboard", authenticateJWT, validatePatientId, caregiverController.getCaregiverDashboard);
 ...
 *       - bearerAuth: []
 */
app.get("/api/caregiver/patients/:patientId/reports", authenticateJWT, validatePatientId, validateAdherenceReportRequest, caregiverController.getAdherenceReports);
 ...
 *       - bearerAuth: []
 */
app.post("/api/caregiver/relationships", authenticateJWT, validateCaregiverRelationship, caregiverController.addCaregiverRelationship);
 ...
 *       - bearerAuth: []
 */
app.post("/api/caregiver/alerts/missed-medication", authenticateJWT, validateMissedMedicationAlert, caregiverController.sendMissedMedicationAlert);
 ...
 *       - bearerAuth: []
 */
app.get("/api/emergency-contacts", authenticateJWT, emergencyContactsController.getEmergencyContacts);
 ...
 *       - bearerAuth: []
 */
app.post("/api/emergency-contacts", authenticateJWT, validateEmergencyContactData, emergencyContactsController.addEmergencyContact);
 ...
 *       - bearerAuth: []
 */
app.put("/api/emergency-contacts/:contactId", authenticateJWT, validateContactId, validateEmergencyContactUpdate, emergencyContactsController.updateEmergencyContact);
 ...
 *       - bearerAuth: []
 */
app.delete("/api/emergency-contacts/:contactId", authenticateJWT, validateContactId, emergencyContactsController.deleteEmergencyContact);
 ...
 *       - bearerAuth: []
 */
app.post("/api/emergency-contacts/test-alert/:contactId", authenticateJWT, validateContactId, emergencyContactsController.testEmergencyAlert);
 ...
 *       - bearerAuth: []
 */
app.get("/api/emergency-contacts/alerts/history", authenticateJWT, validateAlertHistoryRequest, emergencyContactsController.getEmergencyAlertHistory);
 ...
 *       - bearerAuth: []
 */
app.get("/api/health/dashboard", authenticateJWT, validateHealthDashboardParams, healthMetricsController.getHealthDashboard);
 ...
 *       - bearerAuth: []
 */
app.get("/api/health/metrics", authenticateJWT, validateHealthMetricsQuery, healthMetricsController.getHealthMetrics);
 ...
 *       - bearerAuth: []
 */
app.post("/api/health/metrics", authenticateJWT, validateHealthMetric, healthMetricsController.recordHealthMetric);
 ...
 *       - bearerAuth: []
 */
app.get("/api/health/reports/adherence", authenticateJWT, validateAdherenceReportParams, healthMetricsController.generateAdherenceReport);
 ...
 *       - bearerAuth: []
 */
app.get("/api/health/analytics/adherence", authenticateJWT, validateHealthAnalyticsParams, healthMetricsController.getAdherenceAnalytics);
