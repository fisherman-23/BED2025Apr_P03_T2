...
| Feature          | Description                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| ---------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Friend System    | Allows users to add friends through sharing of public UUID, share link or QR Code. Users can accept, reject, or withdraw requests. Users can search for friends as well as filter the system by friend requests and friends.                                                                                                                                                                                                                          |
| Profile Matching | Suggests potential friends or connections based on shared characteristics, like common interests and hobbies. Users can update this profile anytime they want. Once a match profile is created, users will be shown recommended profiles based on their information, including About Me, interests, and age. They can choose to like or skip each profile. If both users like each other, a friend connection is formed, and they can begin chatting. |
...
| **Google Maps Javascript API** | Google Maps Javascript API enables interactive maps within the application. Used for displaying event or facility locations with markers, zoom, and direction controls to enhance navigation and accessibility for users.                        |
